        ...
        <div className="container p-2">
            <div className="flex justify-between">
                <div className="contain-left flex items-center" >
                    ...
                    <div className="mx-4 ms:mx-7 sm:hidden">
