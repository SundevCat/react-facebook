...
const ModalPic = (prop) => {
    ...
    return (
        <div>
            {/* modal edit profile */}
            <Modal show={prop.openEditProfile} onClose={() => prop.toggleModel(false)} className=' bg-zinc-800 bg-opacity-70 pt-14'>
                <div className="relative bg-zinc-800  rounded-lg ">
                    <div className=" relative  p-4 md:p-5 border-b  dark:border-gray-600">
                        ...
                        <button type="button" onClick={() => prop.toggleModel(false)} className=" absolute right-5 top-5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal">
                    ...
                    <div className="p-4 md:p-5  flex">
                        ...
                        <div className=' w-1/4 flex flex-col'>
                            <form className="space-y-6" action="#" onSubmit={uploadImage} encType='multiparo/form-data'>
                                ...
                                <input type='file' name='file' accept='image/*' onChange={previewPic} />
